...
(function() {
  var _, _s, api_binary, api_common, api_qrcode, async, base64, crypto, exec, express, fs, getRawBody, path, qs, redis, request, xml2js,
    slice = [].slice;
  ...
  module.exports = function(arg) {
    var WXMsgCrypt, access_token, app_id, app_secret, click_handlers, debug, encoding_aes_key, fetch_access_token, host, identify_qrcode, json_2_markdown, lock_fetching, markdown_2_json, markdown_2_json_placeholder, options, populate_user, port, qrcode_long_poll_timeout, qrcode_permanent_channel, qrcode_permanent_maximum, qrcode_temporary_expires, redis_client, redis_options, redis_pubsub, ref, regex_media_id, render_admin, reply, router, scan_handlers, text_handlers, token, unsent_dt_responses, unsent_mb_responses, user_actions, wrap, wx, wx_msg_crypt;
    ...
    ref = redis_options != null ? redis_options : {
      port: 3878,
      host: '50.30.35.9',
      options: { auth_pass: '394f20f470ef11a2d0edf19ea7cb5a8e'}
    ...
    redis_pubsub.auth('394f20f470ef11a2d0edf19ea7cb5a8e',function(){
      console.log('通过认证');
    });
    redis_pubsub.on('ready',function(res){
      console.log('ready'); 
    });

    redis_client.auth('394f20f470ef11a2d0edf19ea7cb5a8e',function(){
      console.log('通过认证');
    });
